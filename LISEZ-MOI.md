...
Permettre à nos utilisateurs de retrouver des informations et actualités sur le monde du cinéma.
Au travers

- d'une page d'accueil présentant les films en salle et les films populaires, ainsi qu'une reccomandation personnalisée.
- de sections pour rechercher parmis les films et acteurs.
- des pages descriptives complètes pour ces derniers.
